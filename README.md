...
Visualizações: Análise percentual por Segmento de público (Consumer, Corporate, Home Office), evolução temporal da faturação (2015-2018), ranking de subcategorias (Phones, Chairs, etc.) e o Top 10 de Estados com maior receita (liderado pela Califórnia e Nova Iorque).

Detalhamento de Transações: Um ecrã de auditoria operacional focado na precisão. Apresenta uma matriz detalhada com cada transação, permitindo aos gestores rastrear o Order ID, a data, o nome do cliente, o produto exato e o valor faturado linha a linha.
...
O relatório foi publicado na web e pode ser acedido diretamente pelo navegador através da página HTML alojada neste repositório:

🔗 Clica aqui para aceder ao Dashboard Interativo
 https://otaviovalefuogo.github.io/painel-de-vendas/
